...
<div class="w loc">
    ...
    <p class="r"><a href="index.html" title="商城首页">商城首页</a><samp>&gt;</samp><a href="#" title="手机商城">手机商城</a><samp>
        &gt;</samp><a href="#" title="HTC">HTC</a><samp>&gt;</samp><span class="gray">HTC A6390</span></p>
...
<div class="w ofc mt">
    ...
    <div class="r wr">
        ...
        <div class="product">
            ...
            <div class="showPro">
                <div class="big"><a id="showImg" class="cloud-zoom" href="${file_path }${item.imgs}"
                                    rel="adjustX:10,adjustY:-1"><img title="optional title display" alt=""
                                                                     src="${file_path }${item.imgs}"></a></div>
                <div class="big_type">团购中...</div>
                <div class="small">
                    <span class="smallL" title="向左">&nbsp</span>
                    <div class="smallBox">
                        <div class="smallList">
                            <a class="cloud-zoom-gallery here" title="red" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '/static/img/pic/smallimage.jpg'"><img
                                    alt="thumbnail 1" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '/static/img/pic/smallimage-1.jpg'"><img
                                    alt="thumbnail 2" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '/static/img/pic/smallimage-2.jpg'"><img
                                    alt="thumbnail 3" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '/static/img/pic/smallimage-3.jpg'"><img
                                    alt="thumbnail 4" src="${file_path }${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${file_path }${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '/static/img/pic/smallimage-4.jpg'"><img
                                    alt="thumbnail 5" src="${file_path }${item.imgs}"></a>
                        </div>
                    </div>
                ...
                <div class="share mt">
                    ...
                    <div id="ecpsShareIcon">
                        <div class="iconSmall iconRight">
                            <span>分享到：</span><a href="javascript:void(0);" target="_blank" class="sinawb"
                                                title="分享到新浪微博"></a><a href="javascript:void(0);" target="_blank"
                                                                       class="qqwb" title="分享到腾讯微博"></a><a
                                href="javascript:void(0);" target="_blank" class="renren" title="分享到人人网"></a><a
                                href="javascript:void(0);" target="_blank" class="qqzone" title="分享到QQ空间"></a><a
                                href="javascript:void(0);" target="_blank" class="sohuwb" title="分享到搜狐微博"></a><a
                                href="javascript:void(0);" class="copy" title="复制链接">复制链接</a>
                        </div>
                    </div>
            ...
            <form method="post" action="" name="" class="infor">
                <ul class="uls form">
                    ...
                    <li><label>移 动 价：</label><span class="word"><b class="f14 red mr" id="skuPrice">￥3999.00</b>(市场价:<del id="marketPrice">￥5789.00</del>)</span>
                    </li>
                    ...
                    <li><label>商品评价：</label><span class="word"><span class="val_no val3d4" title="4分">4分</span><var
                            class="blue">(已有17人评价)</var></span></li>
                    <li><label>运　　费：</label><span class="word">包邮&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);"
                                                                                            class="blue">配送区域</a></span>
                    </li>
                    <li><label>库　　存：</label><span class="word" id="stock">有货</span></li>
                    <li><label>支付方式：</label>
                        <div class="pre word p16x16">
                ...
                <div class="box_orange">
                    <ul class="uls form">
                        ...
                        <li><label>我 要 买：</label><a href="javascript:void(0);" class="inb sub"></a><input readonly
                                                                                                          type="text"
                                                                                                          name=""
                                                                                                          value="1"
                                                                                                          class="num"
                                                                                                          size="3"/><a
                                href="javascript:void(0);" class="inb add"></a><em id="sub_add_msg" class="red"></em>
                        </li>
                        <li class="submit"><input type="button" value="" class="hand btn138x40" onclick="buy();"/><input
                                type="button" value="" class="hand btn138x40b" onclick="addCart()"/><a href="#"
                                                                                                       title="加入收藏"
                                                                                                       class="inb fav">加入收藏</a>
                        </li>
                ...
                <dl class="box_orange msg">
                    ...
                    <dd>你可以：<p>1、联系客服电话&nbsp;<var>10086</var>；<br>2、返回&nbsp;<a href="${siteBaseDN}index.html"
                                                                               title="商城首页">商城首页<samp>
                        &gt;&gt;</samp>。</a></p></dd>
                </dl>
        ...
        <div class="box bg_white ofc">
            ...
            <div id="detailTab2" style="display:none">
                ...
                <table cellspacing="0" summary="" class="tab tab7">
                    ...
                    <c:forEach items="${item.paraList}" var="paraVal">
                        <tr>
                            <th class="alg_r">${paraVal.featureName}</th>
                            <td>${paraVal.paraValue}</td>
                        </tr>
